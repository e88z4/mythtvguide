...
public class JobType extends ADatabaseEnumGroup<IJobType.Type> implements IJobType {
	...
	public JobType(ProtocolVersion protoVersion, int dbVersion, int value) {		
		super(Type.class, protoVersion, dbVersion, value);
	}
	
	public static JobType valueOf(ProtocolVersion protoVersion, int dbVersion, String value) {
		return new JobType(protoVersion, dbVersion, Integer.parseInt(value));
	}
	
	public static JobType valueOf(ProtocolVersion protoVersion, int dbVersion, Type type) {
		final int position = type.getPosition();
		return new JobType(protoVersion, dbVersion, position);
	}
}
