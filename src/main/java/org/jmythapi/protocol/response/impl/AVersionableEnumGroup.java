...
public abstract class AVersionableEnumGroup <E extends Enum<E> & IVersionableValue> extends AEnumGroup<E> implements IVersionable {
	...
	public AVersionableEnumGroup(Class<E> enumClass, ProtocolVersion protoVersion, long enumValue) {
		super(enumClass,protoVersion,enumValue);		
	}

	@Override
	public E getEnum() {
		E eValue = EnumUtils.getVersionableValueEnum(
			this.groupClass,
			this.protoVersion,
			Long.valueOf(this.longValue())); 	
		return eValue;
	}
}
