...
import static org.jmythapi.protocol.ProtocolVersion.PROTO_VERSION_54;
 ...
 * 
 * @see IMythCommand#BACKEND_MESSAGE_UPDATE_FILE_SIZE BACKEND_MESSAGE_UPDATE_FILE_SIZE
 * @since {@mythProtoVersion 54}
 */
@MythProtoVersionAnnotation(from=PROTO_VERSION_54)
public interface IUpdateFileSize extends IRecordingEvent<IUpdateFileSize.Props> {
