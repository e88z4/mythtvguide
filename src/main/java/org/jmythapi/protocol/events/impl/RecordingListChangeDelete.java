...
import static org.jmythapi.protocol.events.IRecordingListChangeDelete.Props.CHANNEL_ID;
import static org.jmythapi.protocol.events.IRecordingListChangeDelete.Props.RECORDING_START_TIME;
...
public class RecordingListChangeDelete extends AMythEvent<IRecordingListChangeDelete.Props> implements IRecordingListChangeDelete {
	...
	public RecordingListChangeDelete(ProtocolVersion protoVersion, List<String> eventArguments) {
		super(protoVersion,Props.class,IMythCommand.BACKEND_MESSAGE_RECORDING_LIST_CHANGE + " DELETE",eventArguments);
	}
