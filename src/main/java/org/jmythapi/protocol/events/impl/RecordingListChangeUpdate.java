...
public class RecordingListChangeUpdate extends AMythEvent<IRecordingListChangeUpdate.Props> implements IRecordingListChangeUpdate {
	...
	public RecordingListChangeUpdate(ProtocolVersion protoVersion, List<String> eventArguments) {
		super(protoVersion,Props.class,IMythCommand.BACKEND_MESSAGE_RECORDING_LIST_CHANGE + " UPDATE",eventArguments);
	}
